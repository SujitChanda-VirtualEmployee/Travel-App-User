          ...
          TextFormField(
              ...
              decoration: InputDecoration(
                ...
                contentPadding: EdgeInsets.only(
                    ...
                    left: 30,
                    right: 15),
                // suffix: widget.fieldType == FieldType.password
                //     ? TextButton(
                ...
                labelStyle: CustomStyleClass.onboardingBoyTextStyle.copyWith(
                    color: ColorPalette.dark,
                    fontSize: SizeConfig.textMultiplier * 2),
                floatingLabelStyle: CustomStyleClass.onboardingBoyTextStyle
                    .copyWith(
                        color: ColorPalette.black,
                        fontSize: SizeConfig.textMultiplier * 2),
                hintText: widget.hintText,
                hintStyle: CustomStyleClass.onboardingBoyTextStyle.copyWith(
                    color: ColorPalette.dark,
                    fontSize: SizeConfig.textMultiplier * 2),
                errorStyle: CustomStyleClass.onboardingBoyTextStyle.copyWith(
                    fontSize: 10,
