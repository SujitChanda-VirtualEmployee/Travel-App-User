                  ...
                  ? Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              Image.asset('images/chech_on_ic.png'),
                              const SizedBox(width: 5),
                              Text("The Driver and admin to get your ETA",
                                  style: CustomStyleClass.onboardingBoyTextStyle
                                      .copyWith(
                                          color: ColorPalette.black,
                                          fontWeight: FontWeight.bold,
                        ...
                        Text(
                            ...
                            "Please Select 'Allow all the time' option From Location Permission Section to facilitate and enhance the meeting with the driver at the meeting point.",
                            style: CustomStyleClass.onboardingBoyTextStyle
                                .copyWith(
                                    color: ColorPalette.black,
                                    fontWeight: FontWeight.bold,
